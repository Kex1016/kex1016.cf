function Load() {
    ...
    var sub = ["2D > 3D", "I like fictional characters.", "When in doubt just watch anime.", "Yuri connoisseour.", "This is my site. Yay.", "I'm just a nolife.", "Why are you reading these?","This is an easter egg. Now send it to me.","I hope you're having a great day.","<a href='https://anilist.co/character/19565/Yui-Hirasawa' target='_blank'>Yui</a> best girl."];
...
function Subtitle() {
    ...
    setInterval(function () {
        ...
        setTimeout(function () {
            if(sub[subR]==69){
            sub1.innerHTML = "You've watched " + subLUL + " of these go by.";
